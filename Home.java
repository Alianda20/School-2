import ElectricityManagement.Billcalculation;
import ElectricityManagement.Payment;
import javax.swing.*;
import java.awt.*;
...
public class Home extends JFrame implements ActionListener{
    ...
    Home(String atype, String meter) {
        ...
        JMenuItem billcalc = new JMenuItem("Bill Calculation");
        billcalc.setFont(new Font("MV Boli", Font.BOLD, 15));
        billcalc.setBackground(Color.WHITE);
        billcalc.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        billcalc.setPreferredSize(new Dimension(170, 50));
        billcalc.addActionListener(this);
        info.add(billcalc);
        
        JMenuItem Payment = new JMenuItem("Pay Bill");
        Payment.setFont(new Font("MV Boli", Font.BOLD, 15));
        Payment.setBackground(Color.WHITE);
        Payment.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        Payment.setPreferredSize(new Dimension(170, 50));
